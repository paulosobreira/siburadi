...
public class TreeParser {
     ...
     * @param dirRaiz
     */
    public TreeParser(JProgressBar jProgressBar1,DefaultTreeModel modelodestino, File dirRaiz) {
        super();
        ...
        DefaultMutableTreeNode root =
            new DefaultMutableTreeNode(dirRaiz.getName());
        ...
        DefaultMutableTreeNode superRoot =
            (DefaultMutableTreeNode) modelodestino.getRoot();
        modelodestino.insertNodeInto(
            novoNo, superRoot, superRoot.getChildCount()
        );
    ...
    public void filtraJar(File aFile, DefaultMutableTreeNode node) {
        ...
        for (int i = 0; i < files.length; i++)
            if (files[i].isFile()) {
                ...
                DefaultMutableTreeNode arquivoAtual =
                ...
                String name = files[i].getName();
                DefaultMutableTreeNode diretorioAtual =
